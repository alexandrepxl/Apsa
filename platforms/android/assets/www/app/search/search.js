angular.module('app.search', ['ngCordova'])
    ...
    .controller('SearchMapCtrl', function($scope, $state, $ionicLoading,GoogleMaps, Location, Search, FilterService, $cordovaDevice) {
        ...
        $scope.$watch('range', function (value) {
             ...
             // if (circle) {
                 ...
                 // console.log(circle.set('radius', parseInt(value, 10)));
                 // showMarkersInArea();
             // } 
