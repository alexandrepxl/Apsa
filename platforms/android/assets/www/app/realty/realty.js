...
.controller('realtyCtrl', function($scope, $stateParams, $ionicLoading, $ionicModal, $cordovaSocialSharing, 
	$cordovaGeolocation, $ionicSlideBoxDelegate, Search, FilterService, LocationService, Location, Favorites) {
	...
	Search.setQuery({CodigoImovel: realtyCode , UF: res[4].trim()});
	            ...
	            my_longitude = location.position.longitude;
					...
					promise1.then(function(){
						...
						if (responseArr !== undefined) {
							...
							var lgt = coordenadas[1];

							var from = my_latitude + ',' + my_longitude; 		    // MY LOCATION
							var to = coordenadas; 	                                // RESPONSEARR IMOVEL LOCATION
